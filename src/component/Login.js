...
const Login = () => {
  ...
  const [authenticated, setAuthenticated] = useState(() => {
    // Changed getItem to parse the JSON directly and handle default value inside the function
  ...
  if (authenticated && !check) {
    ...
    return (
      <div className="flex flex-col sm:flex-row justify-between bg-[#F5F5F5] items-center w-full">
        <div className="flex h-[60px] sm:h-[80px] sm:min-h-screen w-full sm:w-[75%] bg-[#4285F4] clipped">
